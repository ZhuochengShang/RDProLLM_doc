...
def run(sc: SparkContext): RasterRDD[Array[Int]] = {
    ...
    //require(forallRaster(rasterOne)(t => t.rasterMetadata == meta1), "RasterOne has inconsistent metadata")
    //require(forallRaster(rasterTwo)(t => t.rasterMetadata == meta2), "RasterTwo has inconsistent metadata")
